...
const data = [
  {
    key: (
      <Image
        source={require("@/assets/images/search/charles-deluvio-K4mSJ7kc0As-unsplash 1.png")}
      />
    ),
  },
  {
    key: (
      <Image
        source={require("@/assets/images/search/jesus-santos-ZBBKk2-Cgf8-unsplash 2.png")}
      />
    ),
  },
  {
    key: (
      <Image
        source={require("@/assets/images/search/jose-alejandro-cuffia-k1LNP6dnyAE-unsplash 2.png")}
      />
    ),
  },
  ...
  const GridView = ({ item }) => {
    return (
      <View style={styles.item}>
        <View style={styles.itemCategoryPhotos}>
          <MutiGallaryIcon />
        </View>
        {item.key}
        <View style={styles.itemCategoryGifContainer}>
